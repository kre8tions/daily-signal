...

{
  ...
  "summary": "2 sentences — what the article argues and what it means for someone trying to think more clearly about the world. Not a news summary. The specific payoff for a curious reader who is building a considered life. Where the article names a specific person, product, organization, or place, include at least one such named example — don't default to generic references ('artists', 'a report', 'officials') when a specific one is available in the article.",
