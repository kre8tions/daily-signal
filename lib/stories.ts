...
- The reader is building a life with intention — creatively, professionally, intellectually — at any stage from late teens on. The hook earns their attention if it tells them something true about how the world works that changes how they see their own situation.
...
Return JSON only, no markdown:
{
  ...
  "lookingForward": "2-3 sentences. Given what this week revealed about how the world works, where should a curious, independently-minded reader building a considered life — late teens upward — put their attention next week? Not predictions — where the pattern leads. What to watch, what to question, what to prepare for in their own work, decisions, and thinking.",
...

{
  ...
  "summary": "2 sentences — what the article argues and what it means for someone trying to think more clearly about the world. Not a news summary. The specific payoff for a curious reader building a considered life, anywhere from late teens upward. Where the article names a specific person, product, organization, or place, include at least one such named example — don't default to generic references ('artists', 'a report', 'officials') when a specific one is available in the article.",
