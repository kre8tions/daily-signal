  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Palette fonts */}
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Raleway:ital,wght@0,300;0,400;0,700;1,300&family=Barlow+Condensed:wght@400;700;900&family=Playfair+Display:ital,wght@0,400;0,700;1,400;1,700&family=Oswald:wght@400;600;700&family=Inter:wght@400;500;700&display=swap" />
